...
* 🚀 **Currently:** Building event-driven applications and refining my understanding of microservices.
...
* 🧩 **Fun Fact:** I've solved over **300+ problems** on LeetCode and love a good DSA challenge!
...
- **Tech Stack:** Java, Spring Boot, Redis, Apache Kafka, MySQL  
- **Key Features:**  
  - 🔐 Secure authentication and authorization using **JWT**  
  - 🛡️ Intelligent **malicious URL detection** to prevent phishing and spam  
  ...
  - 📧 Real-time email notifications using **SendGrid**  
  - 🚀 Scalable backend designed for high throughput and low latency  




### 🚦 [API Rate Limiter](https://github.com/Vishal-Sharma87)
...
| **Concepts** | REST APIs, Microservices basics, Event-Driven Architecture, Rate Limiting (Token Bucket), Caching |
